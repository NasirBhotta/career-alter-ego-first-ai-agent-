...
This repository is configured as a UV workspace, so `crewai/stock_picker` shares the root environment at `D:\AI Agents Course\.venv` instead of creating a separate local virtual environment.
